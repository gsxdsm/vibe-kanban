...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::projects::RunDeploymentScriptRequest::decl(),
        server::routes::projects::RunDeploymentScriptResponse::decl(),
        server::routes::projects::RunDeploymentScriptError::decl(),
        ...
        server::routes::task_attempts::CherryPickToNewBranchRequest::decl(),
        server::routes::task_attempts::CherryPickToNewBranchResponse::decl(),
        server::routes::task_attempts::CherryPickToNewBranchError::decl(),
        ...
        server::routes::task_attempts::RunUserCommandRequest::decl(),
        server::routes::task_attempts::RunUserCommandError::decl(),
