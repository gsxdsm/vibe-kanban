 ...
 */
open_pr: TaskOpenPr | null, id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_workspace_id: string | null, shared_task_id: string | null, created_at: string, updated_at: string, };
...
export type ExecutionProcessRunReason = "setupscript" | "cleanupscript" | "codingagent" | "devserver" | "usercommand";
 ...
 */
capabilities: { [key in string]?: Array<BaseAgentCapability> }, version: string, executors: { [key in BaseCodingAgent]?: ExecutorConfig }, };
...
export type NotificationConfig = { sound_enabled: boolean, push_enabled: boolean, sound_file: SoundFile, script_enabled: boolean, script_command: string | null, browser_enabled: boolean, };
...
export type ScriptContext = "SetupScript" | "CleanupScript" | "DevServer" | "ToolInstallScript" | "UserCommand";
