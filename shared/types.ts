...
export type Project = { id: string, name: string, dev_script: string | null, dev_script_working_dir: string | null, default_agent_working_dir: string | null, remote_project_id: string | null, prefer_remote_branch: boolean, ntfy_enabled: boolean, ntfy_url: string | null, ntfy_topic: string | null, created_at: Date, updated_at: Date, };

export type CreateProject = { name: string, repositories: Array<CreateProjectRepo>, };

export type UpdateProject = { name: string | null, dev_script: string | null, dev_script_working_dir: string | null, default_agent_working_dir: string | null, prefer_remote_branch: boolean | null, ntfy_enabled: boolean | null, ntfy_url: string | null, ntfy_topic: string | null, };
